...
\hypersetup{%
pdfauthor={Tahir Javaid},%
pdftitle={Measurements of Higgs differential cross section and interpretations in $\mathrm{H}\rightarrow{\rm Z}{\rm Z}\rightarrow4\ell$ ($\ell={\rm e},\mu$) channel},%
pdfsubject={CMS},%
...
%\input{strategy}
%\clearpage
%\input{strategy/EventSelection} %%% 
%\clearpage
%\input{strategy/def_fid_vol}
%\clearpage
%\input{strategy/unfolding}
%\clearpage
%\input{Observables} %%% 
%\clearpage
%\input{Categories}  %%% 
...
\begin{appendices}
\input{Appendix/SignalInputs} \label{app:siginputs}
\end{appendices}
\clearpage
